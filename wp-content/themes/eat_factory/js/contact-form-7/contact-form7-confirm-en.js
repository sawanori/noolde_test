...
jQuery(document).ready(function(){
	...
	var option = {
		pages : [
			{
				'path' : ['/en_test/contact/franchise/','/en/contact/'],
				'button' : {
					'areaClassName' : 'submit-button',	//	<p class="submit-button">[submit "送信する"]</p>
					'confirm' : '<input class="button-confirm" type="button" value="Next" />',	//	html
					'rewrite' : '<input class="button-rewrite" type="button" value="Clear" />'	//	html
				}
			}
		],
		validates : {
